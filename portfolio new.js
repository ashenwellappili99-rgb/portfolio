...
if (chatbotToggle && chatbotClose && chatbotWindow) {
    ...
    const botResponses = {
        ...
        expertise: "I specialize in Python development, particularly for AI and Machine Learning. I also have strong foundations in C++ and Web Development. 💻",
        academic: "I am currently an IT undergraduate specializing in AI, focusing on mastering Python libraries like NumPy and Pandas. 🎓",
        freelance: "Yes! I am always open to discussing new projects and collaborations. Reach out via the contact form! 🤝",
        contact: "You can reach me at ashenwellappili99@gmail.com or via my LinkedIn and GitHub profiles. Let's connect! 📧"
    };
    ...
    function processBotResponse(query) {
        ...
        setTimeout(() => {
            ...
            let response = "I'm not sure how to answer that yet, but you can try the buttons above or contact Ashen directly! 😊";

            // Simple keyword matching for manual text input
            if (query.includes('skill') || query.includes('language')) response = botResponses.skills;
            else if (query.includes('project') || query.includes('work')) response = botResponses.projects;
            else if (query.includes('expert') || query.includes('special')) response = botResponses.expertise;
            else if (query.includes('academic') || query.includes('study') || query.includes('university')) response = botResponses.academic;
            else if (query.includes('freelance') || query.includes('hire') || query.includes('job')) response = botResponses.freelance;
            else if (query.includes('contact') || query.includes('email') || query.includes('linkedin')) response = botResponses.contact;
            else if (query.includes('hi') || query.includes('hello') || query.includes('hey')) response = "Hello! 👋 How can I help you today?";
